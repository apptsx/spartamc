...
@Getter
public class AccountSkinResetMessage extends RedisMessage {

    private final UUID accountId;

    public AccountSkinResetMessage(Account account) {
        super(Constant.REDIS_ACCOUNT_SKIN_RESET_CHANNEL);
