...
@Getter
public class AccountClanChangeMessage extends RedisMessage {

    private final UUID accountId;

    public AccountClanChangeMessage(Account account) {
        super(Constant.REDIS_ACCOUNT_CLAN_CHANGE_CHANNEL);
