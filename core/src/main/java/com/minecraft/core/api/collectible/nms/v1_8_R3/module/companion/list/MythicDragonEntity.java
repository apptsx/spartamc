...
public class MythicDragonEntity extends CompanionSlime {
    ...
    public MythicDragonEntity(CompanionOperator companion) {
        super(companion);
        ...
        l_leg_b.getStand().setItemInHand(Item.of(Material.CARPET, 3));
        ...
        l_horn.getStand().setHelmet(Item.of(Material.CARPET, 3));
        ...
        r_horn.getStand().setHelmet(Item.of(Material.CARPET, 3));

        CompanionModel body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
        body2.getStand().setHelmet(Item.of(Material.STAINED_CLAY, 14));
        ...
        back.getStand().setHelmet(Item.of(Material.CARPET, 3));

        CompanionModel body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
        body.getStand().setHelmet(Item.of(Material.STAINED_CLAY, 14));
        ...
        head.getStand().setHelmet(Item.of(Material.SKULL_ITEM, 3)
                .skullByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWMyMGZiYmUxNWQ2ZTU5NDZmOTUyYmMxYjA3NDQ4NmRkMzNlNDZiMjM2MWY3Y2Y2YjBkYTU5MzIzMDc0NCJ9fX0="));
