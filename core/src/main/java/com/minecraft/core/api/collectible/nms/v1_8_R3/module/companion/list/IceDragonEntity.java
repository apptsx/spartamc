...
public class IceDragonEntity extends CompanionSlime {
    ...
    public IceDragonEntity(CompanionOperator companion) {
        super(companion);
        ...
        l_leg_b.getStand().setItemInHand(Item.of(Material.CARPET, 15));
        ...
        l_horn.getStand().setHelmet(Item.of(Material.CARPET, 15));
        ...
        l_wing6.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        r_horn.getStand().setHelmet(Item.of(Material.CARPET, 15));

        CompanionModel body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
        body2.getStand().setHelmet(Item.of(Material.WOOL, 3));
        ...
        l_wing1.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        back.getStand().setHelmet(Item.of(Material.CARPET, 15));

        CompanionModel body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
        body.getStand().setHelmet(Item.of(Material.WOOL, 3));
        ...
        l_wing5.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        l_wing4.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        l_wing3.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        l_wing2.getStand().setHelmet(Item.of(Material.BANNER, 12));

        CompanionModel head = this.buildPart("head", new RelativeLocation(0.4, 0.0, 0.5), false);
        head.getStand().setHelmet(Item.of(Material.SKULL_ITEM, 3).skullByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWNkY2VjZmY0ZjZiYTBiMjQ2Zjc3NzU3NTNkNzkxZjE2YzljNmRlNTUzNWQ3OTUyMzZhNGYzYzhjOWIyOTNiIn19fQ=="));
        ...
        r_wing1.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        r_wing3.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        r_wing2.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        r_wing5.getStand().setHelmet(Item.of(Material.BANNER, 12));
        ...
        r_wing4.getStand().setHelmet(Item.of(Material.BANNER, 12));
