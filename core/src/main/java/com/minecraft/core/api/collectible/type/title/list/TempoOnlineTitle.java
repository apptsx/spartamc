...
public class TempoOnlineTitle extends TitleCollectible {

    public TempoOnlineTitle() {
        super("Tempo Online", TitleCategory.GERAL, CollectibleRarity.COMUM, Arrays.asList(RankType.MEMBER), System.currentTimeMillis());
    ...
    public String getDynamicTitle(Player player) {
        ...
        String date = com.minecraft.core.util.list.DateUtil.getDate(account.getContext().getCreatedAt());
