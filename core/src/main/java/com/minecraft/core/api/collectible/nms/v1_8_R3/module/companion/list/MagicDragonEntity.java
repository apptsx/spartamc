...
public class MagicDragonEntity extends CompanionSlime {
    ...
    public MagicDragonEntity(CompanionOperator companion) {
        super(companion);
        ...
        l_leg_b.getStand().setItemInHand(Item.of(Material.CARPET, 4));
        ...
        l_horn.getStand().setHelmet(Item.of(Material.CARPET, 4));
        ...
        l_wing6.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        r_horn.getStand().setHelmet(Item.of(Material.CARPET, 4));

        CompanionModel body2 = this.buildPart("body2", new RelativeLocation(0.3, 0.0, -0.35), false);
        body2.getStand().setHelmet(Item.of(Material.WOOL, 10));
        ...
        l_wing1.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        back.getStand().setHelmet(Item.of(Material.CARPET, 4));

        CompanionModel body = this.buildPart("body", new RelativeLocation(0.3, 0.0, 0.2), false);
        body.getStand().setHelmet(Item.of(Material.WOOL, 10));
        ...
        l_wing5.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        l_wing4.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        l_wing3.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        l_wing2.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        head.getStand().setHelmet(Item.of(Material.SKULL_ITEM, 3)
                .skullByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzA2ZjQ3ZDNiNzUxNTdjNDU1Njk0MjE2YWU0OGM0NjE5ZGJkNTZjMTMxOWFiYTdiYTY2OWU0NTQxMDkwIn19fQ=="));
        ...
        r_wing1.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        r_wing3.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        r_wing2.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        r_wing5.getStand().setHelmet(Item.of(Material.BANNER, 5));
        ...
        r_wing4.getStand().setHelmet(Item.of(Material.BANNER, 5));
