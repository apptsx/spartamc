...
public class ChimpanzeeCompanion extends CompanionCollectible {

    public ChimpanzeeCompanion() {
        super("Chimpanzé", CollectibleRarity.COMUM, new ArrayList<>(), 5, 1726499355013L,
                "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTQzOTI4ODFhMTNhNDJiMDhhZWI4ODhmMzk5ZTFkZWJkYWNlMDRiYzVhMGUwMWMyMjFjMGI1ZDExZDQwIn19fQ=");
