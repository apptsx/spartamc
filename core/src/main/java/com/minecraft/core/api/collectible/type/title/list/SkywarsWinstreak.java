...
public class SkywarsWinstreak extends TitleCollectible {

    public SkywarsWinstreak() {
        super("Winstreak SkyWars", TitleCategory.SKYWARS, CollectibleRarity.COMUM, Arrays.asList(com.minecraft.core.account.context.objects.rank.type.RankType.MEMBER), System.currentTimeMillis());

        setIcon(Item.of(Material.NAME_TAG));
        setLore(Arrays.asList(
                "§7Mostra sua winstreak atual no SkyWars."
        ));
    }

    @Override
    public String getTitle() {
        return "§eWinstreak: §b0 §8(SkyWars)";
    }
    ...
    public String getDynamicTitle(Player player) {
        ...
        return "§eWinstreak: §b" + member.getTotalWinstreak() + " §8(SkyWars)";
    }
}
