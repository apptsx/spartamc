package com.minecraft.core.api.collectible.util.particle;
...
public enum ParticleEffect {
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center)
            throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        display(offsetX, offsetY, offsetZ, speed, amount, center, new ArrayList<>(Bukkit.getOnlinePlayers()));
    }
    ...
    public void display(ParticleColor color, Location center, double range) throws ParticleVersionException, ParticleColorException {
        ...
        if (!isColorCorrect(this, color)) {
            throw new ParticleColorException("The particle color list is incorrect");
        }
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range)
        ...
        if (!isDataCorrect(this, data)) {
            throw new ParticleDataException("The particle data list is incorrect");
        }
