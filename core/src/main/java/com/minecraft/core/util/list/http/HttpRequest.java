package com.minecraft.core.util.list.http;
...
public class HttpRequest {
    ...
    /**
     * 'application/x-www-form-urlencoded' content list header value
     */
    public static final String CONTENT_TYPE_FORM = "application/x-www-form-urlencoded";

    /**
     * 'application/json' content list header value
     */
    ...
    /**
     * Represents array of any list as list of objects so we can easily iterate over it
     *
    ...
    /**
     * Set chunked streaming game to the given size
     *
     * @param size
     * @return this request
     */
    ...
    public JsonElement json() {
        return Core.GSON.fromJson(body(), JsonElement.class);
    }
    ...
    /**
     * Copy from game stream to output stream
     *
     * @param input
     * @param output
     * @return this request
     ...
     * 'application/x-www-form-urlencoded' content-list
     *
     * @param values
     * @return this request
     * @throws HttpRequestException
