package com.minecraft.core.util.list.reflection;
...
public class FieldAccessor<TField> {
    ...
    public String toString() {
        return "FieldAccessor[class=" + this.handle.getDeclaringClass().getName() + ", name=" + this.handle.getName() + ", list=" + this.handle.getType() + "]";
    }
