package com.minecraft.core.member.list.bedwars.objects.metadata.objects.collectible;
...
public class BedCollectible {

    private final BedCollectibleType type;
    ...
    public boolean equals(Class<? extends BedCollectible> collectibleClass) {
    ...
    public String getPermission() {
        return "arcade.bedwars.collectible." + type.getName().toLowerCase() + "." + name.toLowerCase();
    }
}
