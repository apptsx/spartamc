package com.minecraft.core.member.list.eggwars.objects.metadata.objects.stats;
...
public class EggStats {
    ...
    private int kills, deaths, finalKills, eggDestruction, assists;

    private int winStreak, highWinStreak;

    private int weekWins, weekDefeats, weekMatches, weekKills, weekAssists, weekWinStreak, weekFinalKills, weekEggDestruction;
    private int monthWins, monthDefeats, monthMatches, monthKills, monthAssists, monthWinStreak, monthFinalKills, monthEggDestruction;
    ...
    public void setEggDestruction() {
        this.eggDestruction += 1;

        this.weekEggDestruction += 1;
        this.monthEggDestruction += 1;
    }
