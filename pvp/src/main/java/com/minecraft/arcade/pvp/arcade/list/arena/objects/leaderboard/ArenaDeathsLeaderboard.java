...
public class ArenaDeathsLeaderboard extends LeaderboardHologram {

    public ArenaDeathsLeaderboard(Player host, Arena arena) {
        super("deaths", host, arena, 100);
    }
    ...
    public void handle() {
        ...
        List<PvPMember> memberList = new ArrayList<>(Core.getPvpData().ranking("stats.arena.deaths", getMaxLines()));
